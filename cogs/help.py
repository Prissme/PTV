    ...
    "fr": (
        {
            ...
            "commands": (
                ...
                },
                {
                    ...
                    "description": f"Ouvre ton premier œuf et débloque un compagnon générateur de {Emojis.COIN}.",
                    "icon": "2️⃣",
                },
                {
        ...
        },
        {
            "key": "economy",
            "label": "💰 Économie",
            "description": f"Toutes les commandes liées aux {Emojis.COIN} et mini-jeux.",
            "commands": (
                {
                ...
                },
                {
                    ...
                    "description": f"Tente de voler 75% des {Emojis.COIN} de la cible (50% de base, +5% par grade, +50% max).",
                },
                {
                ...
                },
                {
                    ...
                    "description": f"Résous le code secret pour remporter des {Emojis.COIN} bonus.",
                },
                {
        ...
        },
        {
            ...
            "commands": (
                ...
                },
                {
                    ...
                    "description": f"Revends tes potions contre des {Emojis.COIN}.",
    ...
    "en": (
        ...
        },
        {
            ...
            "commands": (
                ...
                },
                {
                    ...
                    "description": f"50% base chance to steal 75% of someone else's {Emojis.COIN}, +5% per grade (up to +50%).",
                },
                {
                ...
                {
                    "command": f"{PREFIX}mastermind",
                    "description": f"Solve the secret code to earn bonus {Emojis.COIN}.",
                },
                {
                    "command": f"{PREFIX}winstrict",
        ...
        },
        {
            ...
            "commands": (
                ...
                {
                    "command": f"{PREFIX}claim",
                    "description": f"Collect the {Emojis.COIN} generated by your pets.",
                },
                {
                    "command": f"{PREFIX}adminshop",
...
class Help(commands.Cog):
    ...
    async def help_command(self, ctx: commands.Context, *, query: Optional[str] = None) -> None:
        """Envoie un menu déroulant ou le détail d'une commande recherchée en DM."""
        ...
        if query:
            ...
            try:
                ...
                await ctx.send(
                    embed=embeds.error_embed(
                        "Impossible d'envoyer l'aide en DM. Vérifie tes paramètres de confidentialité."
                    )
                )
            else:
                if ctx.guild is not None:
                    await ctx.send("📬 Je t'ai envoyé l'aide en message privé.")
            return
        ...
        view.message = message
        if ctx.guild is not None:
            await ctx.send("📬 Menu d'aide envoyé en message privé.")
