...
PET_SLOT_MAX_CAPACITY: Final[int] = 99
...
_MEXICO_EGG_PETS: Tuple[PetDefinition, ...] = (
    PetDefinition(
        name="El Primo",
        rarity="Épique",
        image_url="https://cdn.discordapp.com/emojis/1546860314992181248.png",
    ...
    PetDefinition(
        name="Amber",
        rarity="Légendaire",
        image_url="https://cdn.discordapp.com/emojis/1546860325876531261.png",
    ...
    PetDefinition(
        name="Mina",
        rarity="Mythique",
        image_url="https://cdn.discordapp.com/emojis/1546860324328710184.png",
    ...
    PetDefinition(
        name=HUGE_ROSA_NAME,
        rarity="Secret",
        image_url="https://cdn.discordapp.com/emojis/1546860322139152494.png",
        base_income_per_hour=HUGE_PET_MIN_INCOME,
        drop_rate=0.000002,
        is_huge=True,
    ),
    PetDefinition(
        ...
        rarity="Secret",
        image_url="https://cdn.discordapp.com/emojis/1546860317324091393.png",
        base_income_per_hour=HUGE_PET_MIN_INCOME,
        drop_rate=0.0000005,
        is_huge=True,
    ),
...
PET_EMOJIS: Final[dict[str, str]] = {
    ...
    "Rosa": _ROSA_EMOJI,
    "Mina": os.getenv("PET_EMOJI_MINA", "<:Mina:1546860324328710184>"),
    ...
    "El Primo": os.getenv("PET_EMOJI_EL_PRIMO", "<:ElPrimo:1546860314992181248>"),
    "Amber": os.getenv("PET_EMOJI_AMBER", "<:Amber:1546860325876531261>"),
    ...
    HUGE_ROSA_NAME: os.getenv("PET_EMOJI_HUGE_ROSA", "<:HugeRosa:1546860322139152494>"),
    TITANIC_POCO_NAME: os.getenv("PET_EMOJI_TITANIC_POCO", "<:TITANICPOCO:1546860317324091393>"),
